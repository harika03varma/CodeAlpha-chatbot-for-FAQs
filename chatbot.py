...
def faq_chatbot():
    print("Harika's Chatbot:Welcome to the FAQ chatbot! Ask me anything about our products, services, or various topics.")
    while True:
        ...
        if user_input in ["hi", "hey", "hello"]:
            print("Harika's Chatbot: Hello! How can I assist you today?")
            continue
        
        # Handle question about how the chatbot is doing
        if user_input in ["how are you?"]:
            print("Harika's Chatbot: I'm doing great, thanks for asking. How about you? How can I assist you today?")
            continue
        
        # Exit condition to break the loop
        if user_input in ["exit", "quit", "bye"]:
            print("Harika's Chatbot: Goodbye!")
            break
        ...
        if confidence > 0.2:  # Adjust the threshold if needed for better performance
            ...
            print("Harika's Chatbot: I'm sorry, I don't understand your question. Could you please rephrase it?")
